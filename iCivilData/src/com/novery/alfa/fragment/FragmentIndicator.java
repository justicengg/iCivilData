...
//	private static final String TAG_TEXT_3 = "text_tag_3";
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.alfa_home_focus,
				R.string.alfa_tab_home, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.drawable.indic_select);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.drawable.alfa_local_normal,
				R.string.alfa_tab_device, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.alfa_remote_normal,
				R.string.alfa_tab_remote, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
		...
		//
		//tools
	/*	mIndicators[3] = createIndicator(R.drawable.alfa_tools_normal,
				R.string.alfa_tab_debug, COLOR_UNSELECT, TAG_ICON_3, TAG_TEXT_3);
		...
		//
		//myhome
		mIndicators[3] = createIndicator(R.drawable.alfa_myhome_normal,
				R.string.alfa_tab_myhome, COLOR_UNSELECT, TAG_ICON_3, TAG_TEXT_3);
		mIndicators[3].setBackgroundColor(Color.alpha(0));
		mIndicators[3].setTag(Integer.valueOf(3));
		mIndicators[3].setOnClickListener(this);
		addView(mIndicators[3]);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.alfa_home_normal);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.alfa_local_normal);
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.alfa_remote_normal);
		...
		/*case 3:
			...
			prevIcon.setImageResource(R.drawable.alfa_tools_normal);
		...
		case 3:
			prevIcon =(ImageView) mIndicators[mCurIndicator].findViewWithTag(TAG_ICON_3);
			prevIcon.setImageResource(R.drawable.alfa_myhome_normal);
			prevText = (TextView) mIndicators[mCurIndicator].findViewWithTag(TAG_TEXT_3);
			prevText.setTextColor(COLOR_UNSELECT);
			break;
		}
		...
		case 0:
			...
			currIcon.setImageResource(R.drawable.alfa_home_focus);
		...
		case 1:
			...
			currIcon.setImageResource(R.drawable.alfa_local_focus);
		...
		case 2:
			...
			currIcon.setImageResource(R.drawable.alfa_remote_focus);
		...
		/*case 3:
			...
			currIcon.setImageResource(R.drawable.alfa_tools_focus);
			currText = (TextView) mIndicators[which].findViewWithTag(TAG_TEXT_3);
			currText.setTextColor(COLOR_SELECT);
			break;*/
		case 3:
			currIcon =(ImageView) mIndicators[which].findViewWithTag(TAG_ICON_3);
			currIcon.setImageResource(R.drawable.alfa_myhome_focus);
			currText = (TextView) mIndicators[which].findViewWithTag(TAG_TEXT_3);
			currText.setTextColor(COLOR_SELECT);
			break;
		}
